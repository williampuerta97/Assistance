        ...
        <div role="tabpanel">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="seccion1">
                    ...
                    <div id="tabseccion" class="col-md-11 dataTables_wrapper dt-bootstrap4"></div><!-- aquí se inyecta el datatable -->
                </div>
                <div role="tabpanel" class="tab-pane ml-5" id="seccion2">
                    ...
                    <form id="form_person" method="post">
                        ...
                        <div class="row form-group align-items-end">
                            <input type="submit" name="submit" value="Guardar" class="btn btn-primary mr-2"/>
